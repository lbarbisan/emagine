...
public class ProfileDAOTest extends BaseDAOTest<Profile> {
	...
	protected Profile createEntity() {
		...
		profile.setDescription("description  &щ~#'{([-|`_ч^р@)]=+}^и$гд%∙*╡?,;.:!з<>");
	...
	protected Collection<Profile> createEntityCollection() {
		...
		profile1.setDescription("description1  &щ~#'{([-|`_ч^р@)]=+}^и$гд%∙*╡?,;.:!з<>");
		profile1.setName("profile1");
		
		Profile profile2 = new Profile();
		profile2.setDescription("description2  &щ~#'{([-|`_ч^р@)]=+}^и$гд%∙*╡?,;.:!з<>");
		profile2.setName("profile2");
		
		Profile profile3 = new Profile();
		profile3.setDescription("description3  &щ~#'{([-|`_ч^р@)]=+}^и$гд%∙*╡?,;.:!з<>");
