...
public class FirmListAction extends BaseAction {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		FirmListForm firmListForm = (FirmListForm) form;
		
		// Retrieve all profiles and set them in the form
		try {
			firmListForm.reset();
			firmListForm.setFirms(ManagerManager.getInstance().getFirmManager().findAll());
