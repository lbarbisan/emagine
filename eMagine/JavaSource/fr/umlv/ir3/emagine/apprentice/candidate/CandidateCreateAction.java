...
public class CandidateCreateAction extends BaseAction {
	...
	public ActionForward create(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		//TODO candidate.getAddressPersonnal().setDepartment(DepartmentEnum.valueOf(candidateForm.getIdPersDepartment()));
		...
		//TODO candidate.setLastSection(DiplomaEnum.valueOf(candidateForm.getIdSection()));
