...
<html:form action="/teacherSearch" method="POST" focus="firstName">
	...
	<div id="actions">
		...
		<ul>
			...
			<li><html:link href="javascript:open_mailing_create_win(document.teacherTutorSearchForm, 'teacherTutor')"><html:img src="/eMagine/common/images/icones/creer_mailing_list.png" titleKey="button.title.email"/></html:link></li>
			<li><html:link href="javascript:open_mailing_win(document.teacherTutorSearchForm, 'teacherTutor')"><html:img src="/eMagine/common/images/icones/mailing.png" titleKey="button.title.email"/></html:link></li>
			<li><html:link href="javascript:open_mail_win(document.teacherTutorSearchForm, 'teacherTutor')"><html:img src="/eMagine/common/images/icones/publipostage.png" titleKey="button.title.mailing"/></html:link></li>
			<li><html:link href="javascript:open_extract_win(document.teacherTutorSearchForm, 'teacherTutor')"><html:img src="/eMagine/common/images/icones/extraire.png" titleKey="button.title.extract"/></html:link></li>
		</ul>
	</div>
