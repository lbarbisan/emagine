...
<html:form action="/teacherSearch" method="POST" focus="firstName">
	...
	<div id="actions">
		...
		<ul>
			...
			<li><html:link href="javascript:open_extract_win('teacherTutor')"><img src="/eMagine/common/images/icones/extraire.png" title="<bean:message key="button.title.extract"/>"/></html:link></li>
		</ul>
	</div>
