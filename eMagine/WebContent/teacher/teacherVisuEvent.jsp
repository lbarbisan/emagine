...
<!--
	...
	function deleteEvents() {
		if(confirm("Souhaitez-vous réellement supprimer ces évenements ?")) {
			document.eventSearchForm.action = "/eMagine/eventDelete.do?from=teacher";
...
<html:form action="/eventSearch.do?action=search&from=teacher" method="POST" focus="lastName">
<div class="tabs_div">
