...
//	document.write('<form>');
	document.write('<tr><td colspan="15" ><img src="' + imgsrc + 'shim.gif" width=1 height=1></td></tr>');
	document.write('<tr>');
	document.write('	<td width="1"><img src="' + imgsrc + 'shim.gif" width=1 height=20></td>');
	document.write('	<td colspan="3" align="right"><img src="' + imgsrc + 'previous.gif" onclick="cal_before(' + day + ');"></td>');
	document.write('	<td colspan=7 align="center" nowrap>');
	...
	document.write('	</td>');
	document.write('	<td align="left" colspan="3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="' + imgsrc + 'next.gif" onclick="cal_after(' + day + ');">&nbsp;&nbsp;<img src="' + imgsrc + 'close.gif" onclick="hideCalendar()"></td>');
	document.write('	<td width=1><img src="' + imgsrc + 'shim.gif" width="1" height="1"></td>');
	document.write('</tr>');
	document.write('<tr><td colspan=15 ><img src="' + imgsrc + 'shim.gif" width=1 height=1></td></tr>');
	document.write('<tr>');
	document.write('	<td width="1"><img src="' + imgsrc + 'shim.gif" width=1 height=1></td>');
	document.write('	<td width="38">' + computedcaldays[0] + '</td>');
	document.write('	<td width="1"><img src="' + imgsrc + 'shim.gif" width=1 height=1></td>');
	document.write('	<td width="38">' + computedcaldays[1] + '</td>');
	document.write('	<td width="1"><img src="' + imgsrc + 'shim.gif" width=1 height=1></td>');
	document.write('	<td width="38">' + computedcaldays[2] + '</td>');
	document.write('	<td width="1"><img src="' + imgsrc + 'shim.gif" width=1 height=1></td>');
	document.write('	<td width="38">' + computedcaldays[3] + '</td>');
	document.write('	<td width="1"><img src="' + imgsrc + 'shim.gif" width=1 height=1></td>');
	document.write('	<td width="38">' + computedcaldays[4] + '</td>');
	document.write('	<td width="1"><img src="' + imgsrc + 'shim.gif" width=1 height=1></td>');
	document.write('	<td width="38">' + computedcaldays[5] + '</td>');
	document.write('	<td width="1"><img src="' + imgsrc + 'shim.gif" width=1 height=1></td>');
	document.write('	<td width="38">' + computedcaldays[6] + '</td>');
	document.write('	<td width="1"><img src="' + imgsrc + 'shim.gif" width=1 height=1></td>');
	document.write('</tr>');
	document.write('<tr><td colspan=15 ><img src="' + imgsrc + 'shim.gif" width=1 height=1></td></tr>');
