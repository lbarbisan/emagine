...
<div id="actions">
	<h2>&nbsp;</h2>
	<ul>
		<li><a href="#"><input type="submit" value="Modifier" title="Modifier l'utilisateur"/></a></li>
		<li><a href="#"><input type="submit" value="Supprimer" title="Supprimer l'utilisateur"/></a></li>
	</ul>
</div>
