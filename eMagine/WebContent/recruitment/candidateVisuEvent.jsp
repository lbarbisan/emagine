...
<ul>
	...
	<span class="tab_clicked"><li><html:link action="/candidateVisuEvent">Ev&eacute;nement</html:link></li></span>
</ul>
</div>
<div class="tabs_div">
...
<div align="center">
	...
	<div align=center>
		...
		<table cellpadding="0" cellspacing="0">
			...
			<tr>
				...
				<td><html:link action="/candidateEventDetail">12.10.2005</html:link></td>
				<td>envoi mail</td>
				<td>pour les jpo</td>
			</tr>
			<tr>
				<td><input type="checkbox" value="ON"  name="all_none"/></td>
				<td><html:link action="/candidateEventDetail">13.10.2005</html:link></td>
				<td>tutelle</td>
	...
	<div id="actions">
		...
		<ul>
			...
			<li><html:link action="/candidateEventExtract"><img src="/eMagine/common/images/icones/extraire.png" title="<bean:message key="button.title.extract"/>"/></html:link></li>
		</ul>
	</div>
	</div>
</form>
