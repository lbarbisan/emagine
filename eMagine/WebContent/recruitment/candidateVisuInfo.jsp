...
<!--
	...
	function deleteCandidate() {
		if(confirm("Souhaitez-vous réellement supprimer ce candidat ?")) {
			open("/eMagine/candidateDelete.do?action=delete&from=modify&currentSelectedIds=" + document.candidateModifyForm.elements['idCandidateToModify'].value, "_self");
		}
	}
...
<div class="tabs_div">
<html:form action="/candidateModify" method="POST" focus="lastName">
	<div class="form">
	<fieldset>
...
<html:errors />
<html:hidden property="idCandidateToModify" />
<html:hidden property="action" />
<div align="right"><font color="red" size="1"><bean:message key="form.msg.obligation.star"/></font></div>
</div>
<div id="actions">
	<ul>
		<li><html:link href="javascript:modifyCandidate();"><html:img src="/eMagine/common/images/icones/modif.png" titleKey="button.title.update" /></html:link></li>
		...
		<li><html:link href="javascript:deleteCandidate();"><html:img src="/eMagine/common/images/icones/supprimer.png" titleKey="button.title.remove" /></html:link></li>
	</ul>
</div>
</html:form>