...
<h2><bean:message key="email.do.title"/><html:link action="/mailingListVisu"><img src="/eMagine/common/images/icones/retour.png" title="<bean:message key="button.title.return"/>"/></html:link></h2>
<br/>
<div class="form">
	<p>
