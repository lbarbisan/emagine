...
<h2><bean:message key="statistics.create.title"/><html:link action="/statisticsVisu"><img src="/eMagine/common/images/icones/retour.png" title="<bean:message key="button.title.return"/>"/></html:link></h2>
<br/>
<div class="form">
