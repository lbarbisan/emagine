...
<h2><bean:message key="student.company.add.title"/></h2>
<br/>
<form name="results">
	<div class="search">
		<p><label for="name"><bean:message key="criteria.search.name"/></label><input type="text" id="name" size="20" /> 
		<html:link action="#"><img src="/eMagine/common/images/icones/search.png" title="<bean:message key="student.search.title"/>"/></html:link></p>
	</div>
