	...
	<html:form action="/apprenticeModify" method="POST" focus="lastName">
		...
		<p><label for="defaultAddress"><bean:message key="radio.adress.current"/></label>
			<logic:notEmpty name="apprenticeModifyForm" property="defaultAddresses">
				<logic:iterate id="defaultAddress" name="apprenticeModifyForm" property="defaultAddresses" type="fr.umlv.ir3.emagine.apprentice.DafaultAddressEnum">
					<html:radio property="idDefaultAdress" value="id" idName="address"/> 
