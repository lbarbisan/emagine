...
<h2><bean:message key="mailingList.create"/> <html:link action="/apprenticeSearch"><img src="/eMagine/common/images/icones/retour.png" title="<bean:message key="button.title.return"/>"/></html:link></h2>
<br/>
<form name="results">
	<div class="form">
