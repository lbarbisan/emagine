...
<h2><bean:message key="apprentice.absence.detail.title"/><html:link action="/apprenticeVisuAbsence"><img src="/eMagine/common/images/icones/retour.png" title="<bean:message key="button.title.return"/>"/></html:link></h2>
<br/>
<form name="results">
	<div class="form">
