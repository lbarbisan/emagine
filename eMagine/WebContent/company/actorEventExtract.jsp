...
<h2><bean:message key="event.extract.title"/><html:link action="/eventSearch.do?action=show&from=firmActor"><img src="/eMagine/common/images/icones/retour.png" title="<bean:message key="button.title.return"/>"/></html:link></h2>
<br/>
<div class="form">
