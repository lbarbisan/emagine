...
<!--
	...
	function deleteEvents() {
		if(confirm("Souhaitez-vous réellement supprimer ces évenements ?")) {
			document.eventSearchForm.action = "/eMagine/eventDelete.do?from=firm";
...
<div class="tabs">
	<ul>
			...
			<span class="tab_clicked"><li><html:link action="/eventSearch.do?action=show&from=firm">Ev&eacute;nement</html:link></li></span>
	</ul>
</div>

<html:form action="/eventSearch.do?action=search&from=firm" method="POST" focus="lastName">
<div class="tabs_div">
