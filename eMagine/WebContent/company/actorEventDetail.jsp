...
<h2><bean:message key="event.detail.title"/><html:link action="/actorVisuEvent"><img src="/eMagine/common/images/icones/retour.png" title="<bean:message key="button.title.return"/>"/></html:link></h2>
<br/>
<div class="form">
