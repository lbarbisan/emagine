...
<div class="tabs_div">
	...
	<div id="actions">
		...
		<ul>
			...
			<li><html:link href="javascript:open_extract_win(firmActorListForm, 'firmActor')"><img src="/eMagine/common/images/icones/extraire.png" title="<bean:message key="button.title.extract"/>"/></html:link></li>
